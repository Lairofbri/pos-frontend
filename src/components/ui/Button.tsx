...
const variants = {
  primary:
    'bg-pos-accent text-white border-pos-accent hover:bg-pos-accent-hover active:bg-pos-accent-hover',
  secondary:
    'bg-transparent text-text-primary border-border hover:border-pos-accent hover:text-pos-accent',
  danger:
